        ...
        <Col l={6} s={12}>
          <div className="card">
            <div className="card-content">
              ...
              <p>There are 3 individual rounds, and each individual round consists of 10 short-answer problems in 60 minutes. Each competitor takes all of the individual rounds in the topics of algebra and number theory, combinatorics and computer science, and geometry. We saw the lack of computer science in other math competitions, so we figured that CMU would be the perfect place for this to start. The round is designed to have no programming knowledge required. Also, due to the novelty of this field of competition math, we're excited to announce that we have provided sufficient preparation material through <a href="https://www.expii.com/map/9794" target="_blank" className="red-text text-darken-2">Expii.com</a>, covering all the necessary topics.</p>
            </div>
